...
async def delete_account(request: aiohttp.web.Request) -> dict[str, Any] | aiohttp.web.Response | None:
...
def setup(app: aiohttp.web.Application) -> None:
    app.add_routes([aiohttp.web.delete(r"/api/accounts", delete_account)])  # type: ignore
